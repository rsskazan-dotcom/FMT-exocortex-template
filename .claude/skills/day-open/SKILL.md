...
**Строка в таблице «IWE за ночь» (шаблон L4, вариант C):** добавлять **только если** Scout реально используется (есть свежие отчёты за окно мониторинга **или** явно включён в extensions/конфиге). Если пайплайн Scout не развёрнут — **не** вставлять строку вида «Scout \| ⚪ \| Нет отчётов» (шум DayPlan). Видео и новости в эту таблицу не дублировать — они уже в шагах 5a2 и 6.
