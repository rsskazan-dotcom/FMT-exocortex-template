...
| `lesson-close.sh` | `scripts/lesson-close.sh` | закрыть занятие в workbook |
...
| `skill-promote.sh` | `scripts/skill-promote.sh` | промоция скилла в платформенный шаблон IWE (v2) |
